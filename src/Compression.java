...
public class Compression {
    ...
    public static String readFromFile(String filePath){                 //Compression     //Reads from the file and Converts all the data to a String
    ...
    Compression(String path){
        readFromFile(path);
        initializingHashMap();
        constructHuffmanTree();
        createPrefixCodes(root, new StringBuilder());
        writeToFile(System.getProperty("user.home") + File.separator +"Desktop"+File.separator+"Compressed.txt");
    }
}
